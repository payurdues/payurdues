    ...
    <div class="member-container container d-flex justify-content-between align-baseline">
        <div class="col col-md-6 p-4 py-5 mx-2 mx-md-0">
            ...
            <div class="">
                ...
                <br>
                <p class="member-container_title">Admin Login</p>
                <br>
                <p class="member-container_subtitle">Login to Admin Dashboard</p>
                <br>
            </div>
            <div class="modal-form">
                ...
                <form action="{{ route('admin.login.submit') }}" method="POST">
                    ...
                    <div class="text-start mb-3">
                        ...
                        <input type="text" class="form-control ps-3" name="email" id="email"
                    ...
                    <div class="text-start mb-3">
                        ...
                        <input type="password" class="form-control ps-3" name="password" id="password"
