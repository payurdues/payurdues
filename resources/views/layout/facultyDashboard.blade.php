                ...
                <div class="sidebar offcanvas-md offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
                    ...
                    <div class="top-sidebar">
                        <ul class="list-unstyled mb-0">
                            <li>
                                <a href="{{route('dashboard.index')}}" class="d-flex align-items-center gap-4 {{   Route::is('dashboard.index') ? 'active' : '' }}">
                            ...
                            <li>
                                <a href="{{route('members.index')}}" class="d-flex align-items-center gap-4 {{   Route::is('members.index') ? 'active' : '' }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a href="{{route('dues.index')}}" class="d-flex align-items-center gap-4 {{   Route::is('dues.index') ? 'active' : '' }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a href="{{route('transactions.index')}}" class="d-flex align-items-center gap-4 {{   Route::is('transactions.index') ? 'active' : '' }}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="bottom-sidebar mt-4">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <a href="#" class="d-flex align-items-center justify-content-center gap-1 btn-pay-gradient" data-bs-toggle="modal" data-bs-target="#addMember">
