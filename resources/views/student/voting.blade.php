...
<html lang="en">
    ...
    <body class="dashboard">
        ...
        <section class="main-content flex-grow-1">
            <div class="px-4 px-lg-5 h-100 d-flex mt-md-5 mt-4 gap-4">
                ...
                <div class="dashboard-content">
                    ...
                    <div class="d-inline-flex align-items-start voting-NavLink">
                    ...
                    <div class="dashboard-content_details mb-5 col">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3" id="ongoingContent">
                             @forelse ($ongoing as $election)
                                <div class="col">
                                    <div class="payable-dues_card countdown_card">
                                         <div class="row g-2">
                                            ...
                                            <a href="{{ route('memebers.elections.show', $election) }}" class="d-flex align-items-center justify-content-center gap-1 btn-pay-gradient-outline">     
                             ...
                             @empty
                                <div class="p-5 d-flex flex-column justify-content-center align-items-center gap-4">
                                    ...
                                    <div class="text-center">
                                        <h4 class="mb-1">No Election at this period</h4>
                                        <p>There is no upcoming election aty this period</p>
                                    </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3" id="pastContent">
                                ...
                                <div class="col">
                                    <div class="payable-dues_card countdown_card">
                                        <div class="row g-2">
                                            ...
                                            <a href="{{ route('election_result', $election) }}" class="d-flex align-items-center justify-content-center gap-1 btn-pay-gradient-outline">     
                                                <p class="">View Details</p>
                                            </a>
                                        </div>
                                    </div>
                             ...
                             @empty
                                <div class="p-5 d-flex flex-column justify-content-center align-items-center gap-4">
                                    ...
                                    <div class="text-center">
                                        <h4 class="mb-1">No Past Election at this period</h4>
                                        <p>There is no past election at this period</p>
                                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const links = [ongoingLink, pastLink];
            const contents = [ongoingContent, pastContent];
