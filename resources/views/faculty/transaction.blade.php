...
@section('content')
                ...
                <form id="filter-form" action="{{ route('transactions.search') }}" method="GET" class="d-flex gap-3">
                    ...
                    <div class="position-relative">
                        <select name="range" id="date-range" class="form-select">
                            ...
                            <option value="yesterday" {{ request('range') == 'yesterday' ? 'selected' : '' }}>Yesterday
                            </option>
                            <option value="this_week" {{ request('range') == 'this_week' ? 'selected' : '' }}>This Week
                            </option>
                        ...
                        <img src="/assets/img/svg/CalendarDots.svg" alt="Calendar"
                            class="ms-3 position-absolute top-50 start-0 translate-middle-y" height="21">
                    </div>
                                ...
                                <tr>
                                    <td class="">
                                        <div class="d-flex align-items-center">
                                            <img class="me-2" src="/assets/img/svg/transaction-out.svg"
                                                style="transform: rotate(180deg);" alt="payYourDues">
                                    ...
                                    <td>{{ $creditTransaction->student->first_name }}
                                        {{ $creditTransaction->student->other_names }}</td>
                                    <td>{{ $creditTransaction->student->matric_no ?? $creditTransaction->student->form_no }}
                                    </td>
    ...
    <div class="modal fade" id="addMemberForm" tabindex="-1" aria-labelledby="addMemberForm" aria-hidden="true">
