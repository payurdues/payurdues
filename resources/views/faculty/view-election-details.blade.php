...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>PayUrDues - View Election Result</title>
            ...
            <div class="px-3 px-lg-5 h-100 d-flex  gap-4">
                ...
                <div class="dashboard-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-self-md-center mt-3 mt-md-5 mb-5 gap-3 ">
                        <a href="voting.html" class="d-flex gap-3 align-items-center ">
                            <img src="../assets/img/svg/ArrowLeft.svg" alt="PayUrDues">
                            <h5 class="dashboard-content_heading text-nowrap">SUG Election</h5>
                        </a>
                    ...
                    <div class="dashboard-content_details mb-5 col">
                        ...
                        <div class="row row-cols-1 row-cols-lg-2 justify-content-between g-3 g-md-5">
                                ...
                                <div class="accordion" id="categoryAccordion2">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button py-4 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#category2" aria-expanded="true" aria-controls="category2">
                                            <h4 class="text-color-gradient">President</h4>
                                            </button>
                                        </h2>

                                        <div id="category2" class="accordion-collapse collapse" data-bs-parent="#categoryAccordion2">
                                            <div class="accordion-body">
                                                <div class="row row-cols-2 g-3">
                                                    
                                                    <div class="col">
                                                            <div class="bg-white mt-3 rounded-4 overflow-hidden p-2 p-md-4 candidate">
                                                            <h5 class="">4501</h5>
                                                            <div class="square-image-container">
                                                                <img src="../assets/img/candidate-3.jpg" class="rounded-3 img-thumbnail" alt="...">
                                                                <div class="bg-gradient p-2">
                                                                    <p class="fw-bold">WINNER</p>
                                                                </div>
                                                            </div>
                                                            <div class="text-center mt-1">
                                                                <h4 class="text-color-gradient text-uppercase">Adewale Ayuba</h3>
                                                    ...
                                                    <div class="col">
                                                        <div class="bg-white mt-3 rounded-4 overflow-hidden p-2 p-md-4 candidate winner">
                                                            <h5 class="">4700</h5>
                                                            <div class="square-image-container">
                                                                <img src="../assets/img/candidate-4.jpg" class="rounded-3 img-thumbnail" alt="...">
                                                                <div class="bg-gradient p-2">
                                                                    <p class="fw-bold">WINNER</p>
                                                                </div>
                                                            </div>
                                ...
                                <div class="accordion" id="categoryAccordion1">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            ...
                                            <h4 class="text-color-gradient">Vice President</h4>
                                            </button>
                                        </h2>
                                            ...
                                            <div class="accordion-body">
                                                <div class="row row-cols-2 g-3">
                                                    ...
                                                    <div class="col">
                                                            ...
                                                            <div class="text-center mt-1">
                                                                <h4 class="text-color-gradient text-uppercase">Adeleke Joshua</h3>
                                                                <p class="fs-small fw-light">(AKA Ake)</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="bg-white mt-3 rounded-4 overflow-hidden p-2 p-md-4 candidate">
                                                            ...
                                                            <div class="text-center mt-1">
                                                                <h4 class="text-color-gradient text-uppercase">Adewale Ayuba</h3>
                                                                <p class="fs-small fw-light">(AKA Badoo)</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col">
                                <div class="accordion" id="categoryAccordion3">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button py-4 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#category3" aria-expanded="true" aria-controls="category3">
                                            <h4 class="text-color-gradient">President</h4>
                                            </button>
                                        </h2>

                                        <div id="category3" class="accordion-collapse collapse" data-bs-parent="#categoryAccordion3">
                                            <div class="accordion-body">
                                                <div class="row row-cols-2 g-3">
